...
{
    /*
     *  TODO: String pool for compression,
     *        Variable name pool for compression
     */
    public static var NAME = "YoYo";
    public static var COMMANDNAME = "yoyo";
    ...
    public static function main()
    {
         ...
         *      }
         *  }
         *  test = example(func(a, b) { print(a, b); });
         *  test(1, 2);
         *
         * 
         * 
         *  func example(f) { return func(*args) { print("test"); return f(*args); } } test = example(func(a, b) { print(a, b); }); test(1, 2);
         * 
         */
        
         
        
        var args:Array<String> = Sys.args(); // ["example.yo", "-interp"];
        ...
        if (args.length == 0) { // open shell
            ...
            if (args[0].substr(0, 2) == "--") {
                ...
                var output:String = null; var i:Int = 0;
                while (i < args.length) {
                    arg = args[i++];
                    if (arg.charAt(0) == "-") {
                        flag = arg.substr(1);
