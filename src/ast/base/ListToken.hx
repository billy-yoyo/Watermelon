...
class ListToken extends Token
{
    ...
    public static function fromRaw(tokens:Array<Token>):ListToken
    {
        var token:ListToken = new ListToken("");
    ...
    public static function partialMatch(s:String):Bool
    {
        ...
        return s.charAt(0) == "[" && ((openCount == closeCount && s.charAt(s.length - 1) == "]") || (openCount > closeCount && (s.length == 1 || s.charAt(s.length - 2) != "]"))); 
    }
