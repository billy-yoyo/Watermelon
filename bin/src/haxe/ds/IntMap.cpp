...
HX_LOCAL_STACK_FRAME(_hx_pos_8a33a2a31f3d5ff5_82_toString,"haxe.ds.IntMap","toString",0xf29c6496,"haxe.ds.IntMap.toString","C:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/IntMap.hx",82,0x604d6034)
namespace haxe{
namespace ds{
...
::String IntMap_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_8a33a2a31f3d5ff5_82_toString)
HXDLIN(  82)		return ::__int_hash_to_string(this->h);
            	}
