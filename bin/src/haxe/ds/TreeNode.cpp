...
HX_LOCAL_STACK_FRAME(_hx_pos_a547912459d988d9_237_toString,"haxe.ds.TreeNode","toString",0xcf78dce3,"haxe.ds.TreeNode.toString","C:\\HaxeToolkit\\haxe\\std/haxe/ds/BalancedTree.hx",237,0x9022da28)
namespace haxe{
namespace ds{
...
::String TreeNode_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a547912459d988d9_237_toString)
HXDLIN( 237)		::String _hx_tmp;
HXDLIN( 237)		if (hx::IsNull( this->left )) {
HXDLIN( 237)			_hx_tmp = HX_("",00,00,00,00);
            		}
            		else {
HXDLIN( 237)			_hx_tmp = (this->left->toString() + HX_(", ",74,26,00,00));
            		}
HXDLIN( 237)		::String _hx_tmp1 = ((HX_("",00,00,00,00) + ::Std_obj::string(this->key)) + HX_("=",3d,00,00,00));
HXDLIN( 237)		::String _hx_tmp2 = (_hx_tmp + (_hx_tmp1 + ::Std_obj::string(this->value)));
HXDLIN( 237)		::String _hx_tmp3;
HXDLIN( 237)		if (hx::IsNull( this->right )) {
HXDLIN( 237)			_hx_tmp3 = HX_("",00,00,00,00);
            		}
            		else {
HXDLIN( 237)			_hx_tmp3 = (HX_(", ",74,26,00,00) + this->right->toString());
            		}
HXDLIN( 237)		return (_hx_tmp2 + _hx_tmp3);
            	}
