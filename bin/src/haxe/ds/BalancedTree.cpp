...
HX_LOCAL_STACK_FRAME(_hx_pos_97671fefbd3e0550_206_toString,"haxe.ds.BalancedTree","toString",0x3e62fddd,"haxe.ds.BalancedTree.toString","C:\\HaxeToolkit\\haxe\\std/haxe/ds/BalancedTree.hx",206,0x9022da28)
namespace haxe{
namespace ds{
...
::String BalancedTree_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_97671fefbd3e0550_206_toString)
HXDLIN( 206)		if (hx::IsNull( this->root )) {
HXDLIN( 206)			return HX_("{}",a2,6b,00,00);
            		}
            		else {
HXDLIN( 206)			return ((HX_("{",7b,00,00,00) + this->root->toString()) + HX_("}",7d,00,00,00));
            		}
