...
HX_LOCAL_STACK_FRAME(_hx_pos_56f7003f49591ffa_128_addInt32,"haxe.io.BytesBuffer","addInt32",0x38ae13d0,"haxe.io.BytesBuffer.addInt32","C:\\HaxeToolkit\\haxe\\std/haxe/io/BytesBuffer.hx",128,0xb51c4e6c)
HX_LOCAL_STACK_FRAME(_hx_pos_56f7003f49591ffa_139_addInt64,"haxe.io.BytesBuffer","addInt64",0x38ae166f,"haxe.io.BytesBuffer.addInt64","C:\\HaxeToolkit\\haxe\\std/haxe/io/BytesBuffer.hx",139,0xb51c4e6c)
...
void BytesBuffer_obj::addInt32(int v){
            	HX_STACKFRAME(&_hx_pos_56f7003f49591ffa_128_addInt32)
HXLINE( 132)		::Array< unsigned char > _hx_tmp = this->b;
HXDLIN( 132)		_hx_tmp->push(((int)v & (int)(int)255));
HXLINE( 133)		::Array< unsigned char > _hx_tmp1 = this->b;
HXDLIN( 133)		_hx_tmp1->push(((int)((int)v >> (int)(int)8) & (int)(int)255));
HXLINE( 134)		::Array< unsigned char > _hx_tmp2 = this->b;
HXDLIN( 134)		_hx_tmp2->push(((int)((int)v >> (int)(int)16) & (int)(int)255));
HXLINE( 135)		::Array< unsigned char > _hx_tmp3 = this->b;
HXDLIN( 135)		_hx_tmp3->push(hx::UShr(v,(int)24));
            	}
...
void BytesBuffer_obj::addInt64( cpp::Int64Struct v){
            	HX_STACKFRAME(&_hx_pos_56f7003f49591ffa_139_addInt64)
HXLINE( 140)		this->addInt32(_hx_int64_low(v));
HXLINE( 141)		this->addInt32(_hx_int64_high(v));
            	}
