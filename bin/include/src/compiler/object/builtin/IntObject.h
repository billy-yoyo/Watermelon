...
#define INCLUDED_src_compiler_object_builtin_IntObject
...
class HXCPP_CLASS_ATTRIBUTES IntObject_obj : public  ::src::compiler::object::builtin::ValuedObject_obj
{
	public:
		typedef  ::src::compiler::object::builtin::ValuedObject_obj super;
		typedef IntObject_obj OBJ_;
		IntObject_obj();

	public:
		enum { _hx_ClassId = 0x22398a09 };
		...
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="src.compiler.object.builtin.IntObject")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"src.compiler.object.builtin.IntObject"); }
		static hx::ObjectPtr< IntObject_obj > __new( ::src::compiler::Scope scope, ::src::compiler::object::ObjectType type, ::haxe::ds::StringMap members, ::Dynamic value,::Array< ::Dynamic> args);
		static hx::ObjectPtr< IntObject_obj > __alloc(hx::Ctx *_hx_ctx, ::src::compiler::Scope scope, ::src::compiler::object::ObjectType type, ::haxe::ds::StringMap members, ::Dynamic value,::Array< ::Dynamic> args);
		...
		::String __ToString() const { return HX_HCSTRING("IntObject","\xee","\xbc","\x11","\xdc"); }

		static int intPower(int x,int power);
		static ::Dynamic intPower_dyn();
		...
		::Dynamic getValue_dyn();
		 ...
		 ::src::compiler::object::Object shiftleft( ::src::compiler::object::Object other);

		 ::src::compiler::object::Object rshiftleft( ::src::compiler::object::Object other);

		 ::src::compiler::object::Object shiftright( ::src::compiler::object::Object other);

		 ::src::compiler::object::Object rshiftright( ::src::compiler::object::Object other);

		 ::src::compiler::object::Object complement();
		 ...
		 ::src::compiler::object::Object negate();
...
#endif /* INCLUDED_src_compiler_object_builtin_IntObject */ 
